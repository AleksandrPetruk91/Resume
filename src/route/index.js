          ...
          projects: [
            {
              ...
              awards: [
                {
                  name: 'Fusce efficitur nisi auctor eros elementum, quis luctus turpis convallis.',
                },
                {
                  name: 'Nullam non nulla quis ante varius auctor. Aliquam ac erat magna.',
                },
              ],
            },
          ],
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get('/shablon', function (req, res) {
  // res.render генерує нам HTML сторінку
